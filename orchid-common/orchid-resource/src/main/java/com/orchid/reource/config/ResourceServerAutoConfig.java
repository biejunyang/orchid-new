package com.orchid.reource.config;

import com.orchid.reource.converter.OrchidJwtAuthenticationConverter;
...
public class ResourceServerAutoConfig extends WebSecurityConfigurerAdapter {
...
//                .and()
            .oauth2ResourceServer()
                .jwt().jwtAuthenticationConverter(new OrchidJwtAuthenticationConverter())
        ;
        // @formatter:on
    }
